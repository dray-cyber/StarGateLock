    ...
    if liste == 1:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylone.grid(row=3, column=0, padx=(952, 100), pady=(30, 0), sticky=W)
    ...
    if liste == 2:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                myltwo.grid(row=4, column=0, padx=(952, 100), pady=(33, 0), sticky=W)
    ...
    if liste == 3:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylthree.grid(row=5, column=0, padx=(952, 100), pady=(33, 0), sticky=W)
    if liste == 4:
        seq4 = sequence[3]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylfour.grid(row=6, column=0, padx=(952, 100), pady=(33, 0), sticky=W)
    if liste == 5:
        seq5 = sequence[4]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylfive.grid(row=7, column=0, padx=(952, 100), pady=(35, 0), sticky=W)
    if liste == 6:
        seq6 = sequence[5]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylsix.grid(row=8, column=0, padx=(952, 100), pady=(35, 0), sticky=W)
    ...
    if liste == 7:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylseven.grid(row=9, column=0, padx=(952, 100), pady=(35, 0), sticky=W)
    if liste == 8:
        seq8 = sequence[7]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                myleight.grid(row=3, column=0, padx=(746, 100), pady=(30, 0))
    if liste == 9:
        seq9 = sequence[8]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylnine.grid(row=4, column=0, padx=(746, 100), pady=(33, 0))
def ref1():
    global mylone
    mylone.destroy()
...
Button(root, image=photoimage1,
       command=sym1).grid(row=0, column=0, padx=(100, 1500), pady=(10, 0))

Button(root, image=photoimage2,
       command=sym2).grid(row=0, column=0, padx=(100, 1400), pady=(10, 0))

Button(root, image=photoimage3, # 3
       command=sym3).grid(row=0, column=0, padx=(100, 1300), pady=(10, 0))

Button(root, image=photoimage4, # 4
       command=sym4).grid(row=0, column=0, padx=(100, 1200), pady=(10, 0))

Button(root, image=photoimage5, # 5
       command=sym5).grid(row=0, column=0, padx=(100, 1100), pady=(10, 0))

Button(root, image=photoimage6, # 6
       command=sym6).grid(row=0, column=0, padx=(100, 1000), pady=(10, 0))

Button(root, image=photoimage7, # 7
       command=sym7).grid(row=0, column=0, padx=(100, 900), pady=(10, 0))

Button(root, image=photoimage8, # 8
       command=sym8).grid(row=0, column=0, padx=(100, 800), pady=(10, 0))

Button(root, image=photoimage9, # 9
       command=sym9).grid(row=0, column=0, padx=(100, 700), pady=(10, 0))

Button(root, image=photoimage10, #10
       command=sym10).grid(row=0, column=0, padx=(100, 600), pady=(10, 0))

Button(root, image=photoimage11, #11
       command=sym11).grid(row=0, column=0, padx=(100, 500), pady=(10, 0))

Button(root, image=photoimage12, #12
       command=sym12).grid(row=0, column=0, padx=(100, 400), pady=(10, 0))

Button(root, image=photoimage13,#13
       command=sym13).grid(row=0, column=0, padx=(100, 300), pady=(10, 0))

Button(root, image=photoimage14,#14
       command=sym14).grid(row=0, column=0, padx=(0, 200), pady=(10, 0))

Button(root, image=photoimage15,#15
       command=sym15).grid(row=0, column=0, padx=(0, 100), pady=(10, 0))

Button(root, image=photoimage16,#16
       command=sym16).grid(row=0, column=0, padx=(0, 0), pady=(10, 0))

Button(root, image=photoimage17,#17
       command=sym17).grid(row=0, column=0, padx=(100, 0), pady=(10, 0))

Button(root, image=photoimage18,#18
       command=sym18).grid(row=0, column=0, padx=(200, 0), pady=(10, 0))

Button(root, image=photoimage19,#19
       command=sym19).grid(row=0, column=0, padx=(300, 0), pady=(10, 0))

Button(root, image=photoimage20,#20
       command=sym20).grid(row=0, column=0, padx=(400, 0), pady=(10, 0))

Button(root, image=photoimage21,#21
       command=sym21).grid(row=0, column=0, padx=(500, 0), pady=(10, 0))

Button(root, image=photoimage22,#22
       command=sym22).grid(row=0, column=0, padx=(600, 0), pady=(10, 0))

Button(root, image=photoimage23,#23
       command=sym23).grid(row=0, column=0, padx=(700, 0), pady=(10, 0))

Button(root, image=photoimage24,#24
       command=sym24).grid(row=0, column=0, padx=(800, 0), pady=(10, 0))

Button(root, image=photoimage25,#25
       command=sym25).grid(row=1, column=0, padx=(100, 1500), pady=(10, 0))

Button(root, image=photoimage26,#26
       command=sym26).grid(row=1, column=0, padx=(100, 1400), pady=(10, 0))

Button(root, image=photoimage27,#27
       command=sym27).grid(row=1, column=0, padx=(100, 1300), pady=(10, 0))

Button(root, image=photoimage28,#28
       command=sym28).grid(row=1, column=0, padx=(100, 1200), pady=(10, 0))

Button(root, image=photoimage29,#29
       command=sym29).grid(row=1, column=0, padx=(100, 1100), pady=(10, 0))

Button(root, image=photoimage30,#30
       command=sym30).grid(row=1, column=0, padx=(100, 1000), pady=(10, 0))

Button(root, image=photoimage31,#31
       command=sym31).grid(row=1, column=0, padx=(100, 900), pady=(10, 0))

Button(root, image=photoimage32,#32
       command=sym32).grid(row=1, column=0, padx=(100, 800), pady=(10, 0))

Button(root, image=photoimage33,#33
       command=sym33).grid(row=1, column=0, padx=(100, 700), pady=(10, 0))

Button(root, image=photoimage34,#34
       command=sym34).grid(row=1, column=0, padx=(100, 600), pady=(10, 0))

Button(root, image=photoimage35,#35
       command=sym35).grid(row=1, column=0, padx=(100, 500), pady=(10, 0))

Button(root, image=photoimage36,#36
       command=sym36).grid(row=1, column=0, padx=(100, 400), pady=(10, 0))

Button(root, image=photoimage37,#37
       command=sym37).grid(row=1, column=0, padx=(100, 300), pady=(10, 0))

Button(root, image=photoimage38,#38
       command=sym38).grid(row=1, column=0, padx=(100, 200), pady=(10, 0))
Button(root, text="reset",#reset
       command=reset).grid(row=1, column=0, padx=(100, 100), pady=(10, 0))
def resetw():
    root.destroy()
Button(root, text="reset window",#reset
       command=resetw).grid(row=1, column=0, padx=(300, 100), pady=(10, 0))
Button(root, image=photoimagedome,
       command=symdome).place(x=1100, y=600)

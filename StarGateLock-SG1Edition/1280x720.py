    ...
    if liste == 1:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylone.grid(row=3, column=0, padx=(952, 100), pady=(0, 25), sticky=W)
    ...
    if liste == 2:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                myltwo.grid(row=4, column=0, padx=(952, 100), pady=(20, 0), sticky=W)
    ...
    if liste == 3:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylthree.grid(row=5, column=0, padx=(952, 100), pady=(25, 0), sticky=W)
    ...
    if liste == 4:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylfour.grid(row=6, column=0, padx=(952, 100), pady=(30, 0), sticky=W)
    if liste == 5:
        seq5 = sequence[4]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylfive.grid(row=7, column=0, padx=(952, 100), pady=(40, 0), sticky=W)
    if liste == 6:
        seq6 = sequence[5]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylsix.grid(row=8, column=0, padx=(952, 100), pady=(30, 0), sticky=W)
    ...
    if liste == 7:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylseven.grid(row=9, column=0, padx=(952, 100), pady=(40, 0), sticky=W)
    ...
    if liste == 8:
        ...
        while ourvarright == False:
            if vardata != ourvar:
                ...
                myleight.grid(row=3, column=0, padx=(746, 100), pady=(0, 0))
    if liste == 9:
        seq9 = sequence[8]
        ourvarright = False
        ourvar = 0
        while ourvarright == False:
            if vardata != ourvar:
                ...
                mylnine.grid(row=4, column=0, padx=(746, 100), pady=(0, 0))
